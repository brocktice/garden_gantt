...
//
// D-27: envelope = { app: 'garden-gantt', version: '0.2', schemaVersion: 2, exportedAt, plan }
...
// (v2) shape; the migration path lives only in src/domain/migrations.ts (consumed by importPlan
