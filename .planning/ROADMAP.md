...
- [x] 03-06-PLAN.md — Lock UI: LockToggle + useLockKeybinding + AppShell undo/redo buttons + ConstraintTooltip top-level mount + remaining @theme tokens (Wave 3)
- [x] 03-07-PLAN.md — App.tsx route wiring + lazy CalendarView + Phase 3 integration smoke + manual checkpoint (Wave 3)
**UI hint**: yes
...
| 4. Polish, Mobile & Ship | 4/7 | In Progress | - |
